                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="" method="post" onsubmit="addAlbum(event)">
                                        @csrf
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 mt-3 mb-2">
                            <h2>
                                <i class="bi bi-eye"></i> Show Albums
                            </h2>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">
                                                <i class="bi bi-pencil-square"></i> Update Album</h5>
...
@section('scripts')
    <script>
        ...
        function addAlbum(e) {
            ...
            axios.post('{{route('manage-album.store')}}', sendData, {
                headers: {
                    'X-CSRF-TOKEN': token
                }
        ...
        function getAllData() {
            axios.get('{{route('manage-album.all-album')}}')
                .then(function (response) {
                    ...
                    html += '</div>';
                    document.querySelector('#result-section').innerHTML = html;
        ...
        function deleteSection(id) {
            ...
            axios.post('{{route('manage-album.delete')}}', sendData)
                .then(function (response) {
                    if (response.data.success) {
                        Swal.fire({
                            icon: 'success',
        ...
        function editSection(id) {
            ...
            axios.post('{{route('manage-album.edit')}}', sendData)
                .then(function (response) {
                    let data = response.data;
        ...
        function updateSection() {
            ...
            axios.post('{{route('manage-album.update')}}', sendData, {
                headers: {
                    'X-CSRF-TOKEN': token
                }
            })
